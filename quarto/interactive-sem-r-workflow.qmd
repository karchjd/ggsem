...
This image can also be loaded in script-based workflow using these codes below into a **ggplot** output directly using the metadata (more information in Chapter 15).
